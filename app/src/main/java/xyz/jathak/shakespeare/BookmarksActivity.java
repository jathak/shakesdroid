...
public class BookmarksActivity extends Activity implements ActionBar.TabListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Bookmarks and Notes");
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            if(position == 0)return new BookmarksFragment();
            if(position == 1)return new NotesFragment();
